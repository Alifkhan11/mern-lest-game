...
import { useCatagoryUpdate, useGetSingleCatagory } from '@/src/hooks/catagory.hooks';
...
const Page = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
            ...
            >
                <h1 className="text-2xl font-bold mb-6 text-center text-black">Update Category</h1>
                ...
                {isDeleted && (
                    <Button onPress={handleUnDeleteCatagory} className="bg-green-500 hover:bg-green-600 mb-6">
                        Un-delete Category
                    </Button>
                )}
